    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <nav className="bg-gray-900 text-white p-6 sticky top-0 z-50 shadow-lg">
        <div className="container mx-auto flex items-center justify-between">
          <h1 className="text-3xl font-bold hover:text-yellow-800">Front-End Developer</h1>
          <div>
      ...
      <main className="flex-grow container mx-auto p-6">
        ...
        <section className="text-center my-12">
          <div className="relative w-40 h-40 mx-auto mb-6">
            <Image
              src="/profile.jpg" 
              alt="Profile Picture"
              className="rounded-full hover:scale-105 transform ease-in-out"
              layout="fill"
            />
          </div>
        ...
        <section id="projects" className="my-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
            ...
            <div className="bg-white shadow-lg rounded-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl flex flex-col hover:flex-grow">
             ...
             <div className="bg-white shadow-lg rounded-lg overflow-hidden transform transition-all duration-300 hover:scale-105 hover:shadow-2xl flex flex-col hover:flex-grow">
              <div className="p-6">
                <h4 className="text-xl font-bold text-gray-800">Dynamic Resume Builder</h4>
                <p className="mt-2 text-gray-600">Resume Builder using TypeScript, Tailwind CSS,React,Shadcn and Next.js.Resume is now on click.</p>
              </div>
            </div>
        ...
        <section id="contact" className="my-12 text-center">
          ...
          <a
            href="mailto:muhammaddanish500@yahoo.com" target='blank'
